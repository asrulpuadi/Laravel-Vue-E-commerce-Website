                ...
                <div class="flex min-h-full items-center justify-center p-4 text-center">
                    <TransitionChild as="template" enter="duration-300 ease-out" enter-from="opacity-0 scale-95" enter-to="opacity-100 scale-100" leave="duration-200 ease-in" leave-from="opacity-100 scale-100" leave-to="opacity-0 scale-95">
                        <DialogPanel class="w-full max-w-md transform overflow-hidden rounded-2xl bg-white text-left align-middle shadow-xl transition-all">
                            <Spinner v-if="loading" class="absolute left-0 top-0 right-0 bottom-0 bg-white flex items-center justify-center"/>
                            ...
                            <form @submit.prevent="onSubmit">
                                <div class="bg-white px-4 pt-5 pb-4">
                                    ...
                                    <CustomInput type="email" class="mb-2" v-model="user.email" label="Email"/>
                                ...
                                <footer class="bg-gray-50 rounded-b-lg px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                                    ...
                                    <button type="button" @click="closeModal()" class="mt-3 w-full inline-flex justify-center rounded-md border bg-white border-gray-300 shadow-sm px-4 py-2 text-base font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm" ref="cancelButtonRef">
                                        Close
                                    </button>
                                </footer>
                            </form>
